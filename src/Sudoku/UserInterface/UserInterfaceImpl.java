...
public class UserInterfaceImpl implements  IUserInterfaceContract.View
    ...
    private IUserInterfaceContract.EventListner listner;
    ...
    private static final Color BOARD_BACKGROUND_COLOR = Color.rgb(0,242,241);
    ...
    private void drawSudokuBoard(Group root) {
        Rectangle boardBackgorund=new Rectangle();
        boardBackgorund.setX(BOARD_PADDING);
        boardBackgorund.setY(BOARD_PADDING);
        boardBackgorund.setWidth(BOARD_X_AND_Y);
        boardBackgorund.setHeight(BOARD_X_AND_Y);

        boardBackgorund.setFill(BOARD_BACKGROUND_COLOR);
        root.getChildren().addAll(boardBackgorund);
    }
    ...
    @Override
    public void setListner(IUserInterfaceContract.EventListner listner) {
